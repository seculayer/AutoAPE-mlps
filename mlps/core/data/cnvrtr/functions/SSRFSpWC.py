...
class SSRFSpWC(SpWCAbstract):
    @staticmethod
    def _load_special_word_dict() -> Tuple[dict, dict]:
        keyword_map_path = "{}/{}".format(Constants.DIR_RESOURCES_CNVRTR, "SSRF_keywords_map.json")
...
if __name__ == '__main__':
    ...
    cvt_fn = SSRFSpWC(arg_list=[50, 255], stat_dict=dict())
